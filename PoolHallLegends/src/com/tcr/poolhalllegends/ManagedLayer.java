...
public abstract class ManagedLayer extends HUD {
	public boolean hasLoaded = false; // Is set TRUE if the layer is loaded.
	public boolean unloadOnHidden; // Set by the constructor, if true, the layer will be unloaded after being hidden.
	// Convenience constructor. Creates a layer that does not unload when hidden.
	public ManagedLayer() {	this(false); }
